...
export namespace CategoriesService {
    export const baseUrl = 'Electro/Categories';
    ...
    export const Methods = {
        Create: "Electro/Categories/Create",
        Update: "Electro/Categories/Update",
        Delete: "Electro/Categories/Delete",
        Retrieve: "Electro/Categories/Retrieve",
        List: "Electro/Categories/List"
    } as const;
