...
[ConnectionKey("Electro"), Module("electroDB"), TableName("Products")]
...
public sealed class ProductsRow : Row<ProductsRow.RowFields>, IIdRow, INameRow
{
    ...
    [DisplayName("Category"), Column("CategoryID"), ForeignKey("Categories", "CategoryID"), LeftJoin(jCategory)]
    [TextualField(nameof(CategoryName))]
